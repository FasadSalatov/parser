...
# -*- coding: utf-8 -*-
"""
Запуск объединённого Telegram бота для парсинга заказов фриланса
Версия с двумя источниками: FreelanceSpace.ru + FL.ru
...
def main():
    ...
    print("🚀 Запуск Freelance Parser Bot (Объединённая версия)")
    print("=" * 70)
    print("📋 Особенности:")
    print("• Парсинг FreelanceSpace.ru + FL.ru")
    print("• Без базы данных - всё в памяти")
    print("• Самый новый заказ отправляется последним")
    print("• Автоматическая фильтрация дубликатов")
...
PARSE_INTERVAL = 300  # 5 минут
        ...
        # Запускаем бот
        from telegram_bot_combined import main as bot_main
        bot_main()
